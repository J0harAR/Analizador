...
public class FrmPrincipal extends javax.swing.JFrame {
        ...
        while (true) {
            ...
            switch (token) {
                ...
                case Identificador:
                    ...
                    /*-----------------------*/
                    case ComillasSimples:
                    resultado += "  <Comillas simples>\t" + lexer.lexeme + "\n";
                    break;
    ...
    private void btnArchivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnArchivoActionPerformed
        ...
        try {
            //extrae el texto que tiene el archivo de texto
	...
	private static <T> boolean checkForDuplicates(T... array)
	{
        ...
        public void cargarTabla(){
            ...
            columna.add("nombre");
            columna.add("valor");
            columna.add("Tipo de dato");
            for (Object col: columna){
                model.addColumn(col);
            }
            this.tablaSim.setModel(model);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            limpiarTablita();
            s.parse();
             ArrayList<objeto>datos= s.action_obj.ta.getArray();
             String[]da;
            for (objeto ob:datos){
                    da=new String[]{""+ob.nombre,""+ob.valor,""+ob.tipo};
                    model.addRow(da);
            
            }

            ArrayList<objeto>repetidos=s.action_obj.ta.Repetidos();
            if(datos.size()!=repetidos.size()){
                
            txtAnalizarSin.setText("Nombre de variables repetidas");
                   txtAnalizarSin.setForeground(Color.red);
            }else{
            txtAnalizarSin.setText("Analisis realizado correctamente");
            txtAnalizarSin.setForeground(new Color(25, 111, 61));
